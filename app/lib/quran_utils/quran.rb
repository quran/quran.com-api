...
module QuranUtils
  class Quran
    ...
    def self.get_muhsaf_page(ayah_id)
      page = 0
      while MUHSAF_PAGES[page] && ayah_id >= MUHSAF_PAGES[page]
        page += 1
      end
