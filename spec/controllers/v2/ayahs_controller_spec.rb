...
RSpec.describe V2::AyahsController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    Audio::Recitation.list_audio_options.each do |recitation|
      ...
      describe "getting surah al baqarah with audio #{id}" do
    ...
    Content::Resource.list_content_options.map do |resource|
      id = resource.resource_id

      describe "getting surah al baqarah with content #{id}" do
    ...
    describe 'getting surah al baqarah with all english content' do
      ids = Content::Resource.list_content_options.find_all{ |r| r.language_code == 'en'}.map(&:id)
