...
ActiveRecord::Schema[7.0].define(version: 2023_03_13_013539) do
  ...
  add_foreign_key "morphology_derived_words", "public.verses", column: "verse_id"
  add_foreign_key "morphology_derived_words", "public.words", column: "word_id"
  ...
  add_foreign_key "morphology_derived_words", "verses"
  add_foreign_key "morphology_derived_words", "words"
  add_foreign_key "morphology_word_grammar_concepts", "public.words", column: "word_id"
  add_foreign_key "morphology_word_grammar_concepts", "words"
  add_foreign_key "morphology_word_grammar_concepts", "public.words", column: "word_id"
  add_foreign_key "morphology_word_grammar_concepts", "words"
  add_foreign_key "morphology_word_segments", "lemmas"
  add_foreign_key "morphology_word_segments", "public.lemmas", column: "lemma_id"
  add_foreign_key "morphology_word_segments", "public.roots", column: "root_id"
  add_foreign_key "morphology_word_segments", "public.topics", column: "topic_id"
  add_foreign_key "morphology_word_segments", "public.words", column: "word_id"
  ...
  add_foreign_key "morphology_word_segments", "topics"
  add_foreign_key "morphology_word_segments", "words"
  add_foreign_key "morphology_word_verb_forms", "public.words", column: "word_id"
  add_foreign_key "morphology_word_verb_forms", "words"
  add_foreign_key "morphology_word_verb_forms", "public.words", column: "word_id"
  add_foreign_key "morphology_word_verb_forms", "words"
  add_foreign_key "morphology_words", "public.verses", column: "verse_id"
  add_foreign_key "morphology_words", "public.words", column: "word_id"
