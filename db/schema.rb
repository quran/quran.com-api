...
ActiveRecord::Schema.define(version: 20181201180917) do
  ...
  create_table "lemma", primary_key: "lemma_id", force: :cascade do |t|
  ...
  create_table "root", primary_key: "root_id", force: :cascade do |t|
    t.string "value", limit: 50, null: false
  ...
  create_table "stem", primary_key: "stem_id", force: :cascade do |t|
    t.string "value", limit: 50, null: false
    t.string "clean", limit: 50, null: false
