...
--
-- Name: in_author; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--

CREATE TABLE in_author (
    author_id integer,
    url text[],
    name text
);
...
--
-- Name: in_resource; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--
...
--
-- Name: in_resource_api_version; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--

CREATE TABLE in_resource_api_version (
    resource_id integer,
    v1_is_enabled boolean,
...
--
-- Name: in_source; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--

CREATE TABLE in_source (
    source_id integer,
    name text,
    url text
);
...
--
-- Name: in_tafsir; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--

CREATE TABLE in_tafsir (
    tafsir_id integer,
    resource_id integer,
    text text
);
...
--
-- Name: in_tafsir_ayah; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--

CREATE TABLE in_tafsir_ayah (
    tafsir_id integer,
    ayah_key text
);
...
--
-- Name: in_translation; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--
...
--
-- Name: in_transliteration; Type: TABLE; Schema: content; Owner: -; Tablespace: 
--

CREATE TABLE in_transliteration (
    resource_id integer,
    ayah_key text,
    text text
);
